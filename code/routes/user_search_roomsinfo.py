...
import requests
import json
from ..models.UserSearchRoomsinfo import *
from ..models.MD5 import *
import time
import datetime
#https://www.supremeproger.com/room/roomsinf/resident/get
user_search_roomsinfo = Blueprint('user_search_roomsinfo', __name__)

@user_search_roomsinfo.route('/room/roomsinf/resident/get', methods=['POST'])
def index():
    ...
    if prove_h == get_info['prove']:
        ...
        if data:
            datas = {"errcode": 0, "roomlist ": data, "stamp": stamp_h, "tableProve": table_prove}
