...
import requests
import json
from ..models.UserUpdataAir import *
from ..models.MD5 import *
import time

#https://www.supremeproger.com/hardware/air_condition/user/push
user_updata_air = Blueprint('user_updata_air', __name__)

@user_updata_air.route('/hardware/air_condition/user/push', methods=['POST'])
def index():
