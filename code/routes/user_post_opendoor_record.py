...
import requests
import json
from ..models.UserPostRecord import *
from ..models.MD5 import *
import time

#https://www.supremeproger.com/record/unlock/user/post
user_post_opendoor_record = Blueprint('user_post_opendoor_record', __name__)

@user_post_opendoor_record.route('/record/unlock/user/post', methods=['POST'])
def index():
