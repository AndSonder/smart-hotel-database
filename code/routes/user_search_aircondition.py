...
import requests
import json
from ..models.UserSearchAircondition import *
from ..models.MD5 import *
import time
import datetime
#https://www.supremeproger.com/hardware/air_condition/resident/get
user_search_aircondition = Blueprint('user_search_aircondition', __name__)

@user_search_aircondition.route('/hardware/air_condition/resident/get', methods=['POST'])
def index():
