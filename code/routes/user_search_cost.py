...
import requests
import json
from ..models.UserSearchCost import *
from ..models.MD5 import *
import time
import datetime
#https://www.supremeproger.com/order/orderinf_amountsPay/resident/get
user_search_cost = Blueprint('user_search_cost', __name__)
@user_search_cost.route('/order/orderinf_amountsPay/resident/get', methods=['POST'])
def index():
