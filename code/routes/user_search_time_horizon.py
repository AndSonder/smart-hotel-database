...
import requests
import json
from ..models.UserSearchTime import *
from ..models.MD5 import *
import time
import datetime
#https://www.supremeproger.com/system/time_limit/resident/get
user_search_time_horizon = Blueprint('user_search_time_horizon', __name__)
@user_search_time_horizon.route('/system/time_limit/resident/get', methods=['POST'])
def index():
