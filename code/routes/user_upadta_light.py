...
import requests
import json
from ..models.UserUpdataLight import *
from ..models.MD5 import *
import time

#https://www.supremeproger.com/hardware/light/user/push
user_upadta_light = Blueprint('user_upadta_light', __name__)

@user_upadta_light.route('/hardware/light/user/push', methods=['POST'])
def index():
