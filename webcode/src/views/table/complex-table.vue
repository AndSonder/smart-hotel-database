    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="130px"
        ...
        <el-form-item label="预计入住时间" prop="scid">
          <el-date-picker v-model="temp.scid" type="datetime" placeholder="请选择一个日期"/>
        </el-form-item>
        <el-form-item label="预计离开时间" prop="sgo">
          <el-date-picker v-model="temp.sgo" type="datetime" placeholder="请选择一个日期"/>
        </el-form-item>
        <el-form-item label="实际入住时间" prop="cid">
          <el-date-picker v-model="temp.cid" type="datetime" placeholder="请选择一个日期"/>
        </el-form-item>
        <el-form-item label="实际离开时间" prop="go">
          <el-date-picker v-model="temp.go" type="datetime" placeholder="请选择一个日期"/>
        </el-form-item>
        <el-form-item label="用户微信id" prop="wecharid">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        cid: [{type: 'date', required: true, message: '预定离开日期不能为空', trigger: 'change'}],
        cgo: [{type: 'date', required: true, message: '预定离开日期不能为空', trigger: 'change'}],
        wecharid: [{type: 'date', required: true, message: '用户微信id不能为空', trigger: 'change'}],
        room_id: [{type: 'date', required: true, message: '用户房间编号不能为空', trigger: 'change'}]
      },
